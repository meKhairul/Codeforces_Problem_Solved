...
ll n,m,k,ans,ok,cnt,a[100005],l,r,mid1,mid2,sum,mx,t;

vector<ll>adj[200005],vec;
...
void solve()
{
    l=1;r=pow(9999999999,(1.0/(n-1)));mx=1000000000000000;
    //cout << "r: " << r << "\n";
    while(r-l>=5)
    {
        ...
        t=check(mid1);m=check(mid2);
        //cout << "t: " << t << " m: " << m << "\n";

        if(t>m){l=mid1;mx=min(mx,m);}
        else {r=mid2;mx=min(mx,t);}

        //cout << "l: " << l << " r: " << r << " " << " mid1:" << mid1 << " mid2: " << mid2 << "\n"  ;
    }
    //cous(l);coul(r);
    for(int i=l;i<=r;i++)
    {
